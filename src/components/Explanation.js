			...
			<Row type="flex" justify="center">
				<div className="explanation-content">
					...
					<div className="explanation-content-text">
						The state of grid initializes as an empty array but will eventually
						hold a nested array representing the columns and rows filled with
						either 0's or 1's to show the dead or alive boxes. The rows and
						columns state values represent the number of rows and columns in the
			...
			<Row type="flex" justify="center">
				<div className="explanation-content">
					...
					<div className="explanation-content-text">
						...
						current state value of started.
					</div>
				</div>
			</Row>
		</div>
